...
词汇按常用度参考排序。每个 JLPT 等级排名最前的 **100 个词**均配有独立人工审核例句，共 **500 个高频词例句**；此外仍保留部分精选词的人工例句。没有审核例句的词条不会显示例句。
...
`vocab-examples-review.js` 保存早期精选词的人工复查例句；`vocab-examples-highfreq-*` 为各级频率前 100 词提供独立、人工审核的高质量例句。频率排序本身不会产生任何例句。
...
- 每级前 100 高频词全部具有人工审核例句（共 500 条）
- 所有运行时可见词汇例句均带 reviewed 标记且不重复
- 所有语法点至少 2 条完整日中例句且全部有接续标签
- 接续术语、详细词性和变形数据完整性
- 各级最低词汇量与总内容量
