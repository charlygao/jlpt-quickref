...
词汇按常用度参考排序。按页面渲染顺序，N1 已连续覆盖前 **2,374 个词**，N5 的 **773 个词**、N4 的 **648 个词**、N3 的 **1,693 个词**与 N2 的 **1,962 个词已全部覆盖**，共 **7,450 个连续覆盖词汇例句**；此外仍保留部分精选词的人工例句。当前全站共有 **7,464 条**审核词汇例句，没有审核例句的词条不会显示例句。
...
`vocab-examples-review.js` 保存早期精选词的人工复查例句；`vocab-examples-highfreq-*` 分批为各级词汇提供独立、人工审核的高质量例句，目前已按页面渲染顺序覆盖 N1 前 2,374 词，并完整覆盖 N5 的 773 词、N4 的 648 词、N3 的 1,693 词和 N2 的 1,962 词。频率排序本身不会产生任何例句。
...
- 按页面渲染顺序，N1 前 2,374 词，以及 N5 全部 773 词、N4 全部 648 词、N3 全部 1,693 词和 N2 全部 1,962 词具有人工审核例句（共 7,450 条，CI 使用可独立调整的分级阈值）
